      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={styles.glassPanel}>
          <div style={{ display: 'flex', flexDirection: 'column', md: { flexDirection: 'row' } }}>
            ...
            <div style={{ flex: '1', minWidth: '300px', backgroundColor: '#020617', padding: '40px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid rgba(255,255,255,0.05)' }}>
              
              {/* Imagen Principal */}
              <div style={{ width: '100%', height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                <img 
              ...
              {Array.isArray(cel.imagen_url) && cel.imagen_url.length > 1 && (
                <div style={{ display: 'flex', gap: '10px', overflowX: 'auto', maxWidth: '100%', padding: '10px' }}>
                  {cel.imagen_url.map((url, i) => (
                    <img 
                      ...
                      style={{ 
                        ...
                        border: fotoActiva === url ? '2px solid #F59E0B' : '2px solid transparent',
            ...
            <div style={{ flex: '1', padding: '50px' }}>
              ...
              {/* Footer de Compra */}
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '30px' }}>
                <div>
                  <span style={{ display: 'block', fontSize: '0.8rem', color: '#94a3b8', fontWeight: 'bold', textTransform: 'uppercase', marginBottom: '5px' }}>Precio Total</span>
